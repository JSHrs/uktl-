...
- `/app` now requires sign-in and returns the visitor to the page they wanted afterwards. The candidate menu is Dashboard · My CV · Job matches · All jobs · HR & Law · Profile; staff tools are no longer in it.
...
- The lockfile was regenerated; `main` CI had been failing at `npm ci` since 18 September.
