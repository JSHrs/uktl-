 ...
 * `solid` is a sticky bar for inner pages.
 */
      ...
      <ul className="hidden md:flex gap-7 items-center list-none p-0 m-0">
        ...
        {signedIn || isAdmin ? (
          <>
            {isAdmin && (
              <li>
                <Link to="/admin" className="text-[13px] text-ink-mute hover:text-ink transition-colors">
                  Admin
                </Link>
              </li>
            )}
                ...
                <>
                  ...
                  {isAdmin && (
                    <Link
                      to="/admin"
                      onClick={() => setOpen(false)}
                      className="w-full text-center text-[14px] px-6 py-4 border border-rule text-ink rounded-full"
                    >
                      Admin dashboard
                    </Link>
                  )}
